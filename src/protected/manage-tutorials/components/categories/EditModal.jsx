...
import { updateCategory } from '../../../../apis/categoriesActions';
...
const EditModal = ({ setShoweditform, objtoedit }) => {
    ...
    const [category, setCategory] = useState(objtoedit?.category);
    ...
    const handleUpdate = (e) => {
        ...
        updateCategory(token, data, setSuccess, setError, setUpdating)
    }

...
import { updateSubject } from '../../../../apis/subjectsActions'

const EditModal = ({ setShoweditform, objtoedit }) => {

    const { token, refreshRecord } = useContext(AuthContext);

    const [subject, setSubject] = useState(objtoedit?.subject);
    ...
    const handleUpdate = (e) => {
        ...
        updateSubject(token, data, setSuccess, setError, setUpdating)
    }
